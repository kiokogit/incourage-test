...
-- DATA
-- ADMIN
INSERT INTO admins(firstname, lastname, contactnumber, email, address, username, password)
VALUES ('Kioko', 'Vince', 112233, 'admin@gmail.com', 'Daraga Albay',  'admin', 'admin');
...
UPDATE clients SET firstname = 'Ian Czar', lastname = 'Dino', contactNumber = 112233, address = 'Daraga Albay', email = 'ianczar@gmail.com', username = 'ian2' WHERE client_id = 9 RETURNING *;
...
--! SHOWS BOTH THAT HAS TRUE CONDITION
 ...
 SELECT * FROM clients AS c LEFT JOIN loans AS l ON c.client_id = l.client_id WHERE c.client_id = 1;
